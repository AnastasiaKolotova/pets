    ...
    return (
        <div className="body">
            ...
            <main style={{"minHeight":"70vh"}}>
                <h1 className="title">Редактирование объявления</h1>
                ...
                <form className="w-50 m-auto p-3" style={{"minWidth":"300px"}}>
                    ...
                    <div className="mb-3">
                        ...
                        <div className="form-text">Мы никогда не распространяем Ваши e-mail другим людям.</div>
                    </div>
                    ...
                    <div className="mb-3 form-check border p-3">
                        ...
                        <label htmlFor="confirm_password" className="form-label hidden">Повторите пароль:</label>
